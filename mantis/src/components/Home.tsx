      ...
      >
        ...
        <div className='md:w-1/2 p-4 flex flex-col justify-center z-10'>
          ...
          <p className='text-xl font-light text-gray-900 bg-white/40 backdrop-blur-sm p-4 rounded-md'>
            ...
            to provide dynamic load balancing, performance monitoring, and
      ...
      <section className='bg-[#1a1a1a] text-white flex flex-col md:flex-row items-center justify-evenly py-12'>
        ...
        >
          ...
          <p className='mt-2 text-base'>
            ...
            ensuring efficient microservice distribution and preventing
            overload.{' '}
          </p>
        </div>
        {/* Feature 2 */}
        ...
        >
          ...
          <p className='mt-2 text-base'>
            Tracks resource usage trends to help engineers manually optimize
            scaling decisions, improving efficiency and reducing costs.
          </p>
        </div>
        {/* Feature 3 */}
        <div
        ...
        >
          ...
          <p className='mt-2 text-base'>
            Engineers gain instant visibility into microservice performance with
            Prometheus, Grafana dashboards, and real-time WebSocket updates for
      ...
      <section className='bg-white text-gray-800 p-8'>
        <div className='max-w-4xl mx-auto'>
          ...
          <p className='mb-4 text-xl'>
            Get started with Mantis quickly and easily. Install our NPM
            package...
          </p>
