...
const Dashboard: React.FC<DashboardProps> = ({ loggedInUser }) => {
  ...
  const iframeUrls = {
    ...
    overview: {
      latency: "http://localhost:3000/d-solo/dee5d7b3eom4ge/new-dashboard?orgId=1&timezone=browser&var-bucket=bucket_test&panelId=1&__feature.dashboardSceneSolo",
      rps: "http://localhost:3000/d-solo/fee6m6sncf56oa/rps?orgId=1&timezone=browser&panelId=1&__feature.dashboardSceneSolo",
      traffic: "http://localhost:3000/d-solo/dee6ii6wsk7pcf/traffic?orgId=1&timezone=browser&panelId=1&__feature.dashboardSceneSolo",
    ...
    p99: "http://localhost:3000/d-solo/dee637m08bgg0a/p99?orgId=1&timezone=browser&var-bucket=_monitoring&panelId=1&__feature.dashboardSceneSolo",
    error400: "http://localhost:3000/d-solo/bee5sivy2wfeod/errors4xx?orgId=1&timezone=browser&var-bucket=bucket_test&panelId=1&__feature.dashboardSceneSolo",
    rps: "http://localhost:3000/d-solo/fee6m6sncf56oa/rps?orgId=1&timezone=browser&panelId=1&__feature.dashboardSceneSolo",
    traffic:"http://localhost:3000/d-solo/dee6ii6wsk7pcf/traffic?orgId=1&timezone=browser&panelId=1&__feature.dashboardSceneSolo"
  };
