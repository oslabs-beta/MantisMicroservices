      ...
      <main>
        ...
        <section id='introduction' className='mb-8'>
          ...
          <p className='text-xl mb-4'>
            Mantis is a browser-based microservice dashboard designed to provide
            dynamic load balancing, performance monitoring, and observability
            for your applications. This guide offers detailed insights and
            tutorials on how to get started with Mantis.
          </p>
        </section>
        <section id='installation' className='mb-8'>
          <h2 className='text-3xl font-semibold mb-3'>Installation</h2>
          <p className='text-xl mb-4'>To install Mantis, use npm:</p>
          <pre className='bg-gray-200 p-4 rounded'>
            <code>npm install mantis-sdk</code>
          </pre>
        </section>
        <section id='usage' className='mb-8'>
          <h2 className='text-3xl font-semibold mb-3'>Usage</h2>
          <p className='text-xl mb-4'>
            After installation, integrate Mantis into your microservices
            environment. To launch the dashboard, run:
          </p>
          <pre className='bg-gray-200 p-4 rounded'>
            <code>npm run start:dashboard</code>
          </pre>
          <p className='text-xl mt-4'>
            The dashboard provides various panels to monitor system performance
            and dynamic load distribution.
          </p>
        </section>
        <section id='contributing' className='mb-8'>
          <h2 className='text-3xl font-semibold mb-3'>Contributing</h2>
          <p className='text-xl mb-4'>
            We welcome community contributions. For more information, please
            refer to our{' '}
            <a
        ...
        <section id='license' className='mb-8'>
          ...
          <p className='text-xl'>
            Mantis is released under the MIT License. Please see the LICENSE
            file for details.
          </p>
        </section>
      </main>
